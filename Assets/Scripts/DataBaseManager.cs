...
public class DataBaseManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        skillEffects.Add(new SkillEffect(1002, 10, 200, 10));
        skillEffects.Add(new SkillEffect(1003, 10, 200, 10));
        skillEffects.Add(new SkillEffect(1004, 10, 200, 10));
        skillEffects.Add(new SkillEffect(1005, 10, 200, 10));
        skillEffects.Add(new SkillEffect(1006, 10, 200, 10));
        skillEffects.Add(new SkillEffect(1007, 10, 200, 10));
        skillEffects.Add(new SkillEffect(1008, 10, 200, 10));
    }
}
